...
import type { Conversation, Project, SearchHit } from "@/types";
  ...
  return (
    ...
    >
      ...
      <div className="space-y-0.5 px-2 pb-2">
        ...
        <Link to="/waitlist" className={navLink} data-testid="nav-early-access">
          <Sparkles className="h-3.5 w-3.5 text-[#b8552f]" /> Join Beta
        </Link>
      </div>
      ...
      <div className="border-t border-border px-3 py-3">
        <div className="mb-2 truncate text-[11.5px] text-muted-foreground">Anonymous workspace</div>
        <div className="flex">
          <Link
            to="/settings"
